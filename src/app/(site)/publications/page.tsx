...
export const metadata: Metadata = {
  title: "Publications",
  description: "37 peer-reviewed publications by Dr. Prasenjit Dey in journals including IEEE Transactions, Pattern Recognition, Scientific Reports, and more. Search and filter by year or type.",
};
