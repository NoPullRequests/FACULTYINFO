...
const faqs = [
  {
    ...
    answer:
      "Send your CV, academic transcripts, statement of research interests, and 2–3 references to deyp@nitrkl.ac.in. Ensure you meet NIT Rourkela's Ph.D. admission requirements (GATE/NET qualification). Shortlisted candidates will be contacted for an interview within 1–2 weeks.",
  },
  {
    id: "research-areas",
