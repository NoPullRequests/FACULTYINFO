      ...
      <div className="mt-8">
        <SettingsAdmin
          ...
          initial={{
            ...
            education:  (site.education  ?? []) as unknown as Array<{ degree: string; institution: string; year: string; field?: string; thesis?: string }>,
            experience: (site.experience ?? []) as unknown as Array<{ title: string; organization: string; department?: string; start: string; end?: string }>,
            awards:     (site.awards     ?? []) as unknown as Array<{ title: string; organization: string; year: string }>,
          }}
        />
      </div>
    </div>
