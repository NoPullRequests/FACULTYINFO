...
import { ExternalLink, FileText, Copy, Check, Quote } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      {publication.abstract && (
        <p className="mt-2.5 text-sm text-muted-foreground leading-relaxed border-l-2 border-primary/20 pl-3">
          {publication.abstract}
        </p>
      )}
